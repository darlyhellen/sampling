package com.xiangxun.sampling.widget.image;
...
//      setBackgroundColor(mBgColor);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mState == STATE_TRANSFORM_IN || mState == STATE_TRANSFORM_OUT) {
            ...
            if (mTransformStart) {
                DLog.d("Dean", "mTransfrom.startScale:" + mTransfrom.startScale);
                DLog.d("Dean", "mTransfrom.startScale:" + mTransfrom.endScale);
                DLog.d("Dean", "mTransfrom.scale:" + mTransfrom.scale);
                DLog.d("Dean", "mTransfrom.startRect:" + mTransfrom.startRect.toString());
                DLog.d("Dean", "mTransfrom.endRect:" + mTransfrom.endRect.toString());
                DLog.d("Dean", "mTransfrom.rect:" + mTransfrom.rect.toString());
            }
