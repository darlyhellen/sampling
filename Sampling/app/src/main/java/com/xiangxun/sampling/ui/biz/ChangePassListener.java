...
public class ChangePassListener implements FramePresenter {
    ...
    public void ChangePass(String oldpasswords, String newpasswords, final FrameListener<String> listener) {
        ...
        RequestBody body = RequestBody.create(okhttp3.MediaType.parse("application/x-www-form-urlencoded"), RxjavaRetrofitRequestUtil.getParamers(new ChangePassParamer(oldpasswords, newpasswords), "UTF-8"));
