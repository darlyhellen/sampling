package com.xiangxun.video.camera;
...
import static com.xiangxun.video.camera.util.FileUtils.deleteDir;
import static com.xiangxun.video.camera.util.FileUtils.deleteFile;
    ...
    public static boolean copyFile(MediaObject mMediaObject) {
        try {
            ...
            if (oldfile.exists()) { //文件存在时
                ...
                FileOutputStream fs = new FileOutputStream(VCamera.getCacheFile().getPath() + mMediaObject.getName() + ".mp4");
            ...
            mMediaObject.setOutputVideoPath(VCamera.getCacheFile().getPath() + mMediaObject.getName() + ".mp4");
            return true;
        } catch (Exception e) {
